...
OrganizationMemberList, OrganizationMemberCreateView, OrganizationMemberUpdateView, OrganizationMemberDeleteView, \
...
urlpatterns = [
    ...
    path('organizationmember_list', OrganizationMemberList.as_view(), name='organizationmember-list'),
    path('organizationmember_list/add', OrganizationMemberCreateView.as_view(), name='organizationmember-add'),
    path('organizationmember_list/<pk>',OrganizationMemberUpdateView.as_view(), name='organizationmember-update'),
    path('organizationmember_list/<pk>/delete', OrganizationMemberDeleteView.as_view(), name='organizationmember-delete'),
